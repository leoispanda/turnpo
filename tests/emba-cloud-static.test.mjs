...
assert.ok(!embaJs.includes("Show month"));
...
assert.ok(embaHtml.includes("EMBA Knowledge Base | Turnpo"));
...
assert.ok(!embaHtml.includes('class="emba-stage"'));
assert.ok(!embaHtml.includes('id="embaTimeline"'));
assert.ok(!embaHtml.includes('id="embaMonthDetail"'));
assert.ok(!embaHtml.includes("Classmate detailed list"));
