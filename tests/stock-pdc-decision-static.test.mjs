...
assert.ok(decisionHtml.includes("5 PDC × Top 30"));
assert.ok(decisionHtml.includes("Top 20 × 5 PDC"));
...
assert.ok(decisionJs.includes("decision-archive-card"));
assert.ok(decisionJs.includes("function archiveMemberMarkup"));
assert.ok(decisionJs.includes("function archivePoolMarkup"));
assert.ok(decisionJs.includes("function archiveFinalMarkup"));
...
assert.ok(decisionJs.includes('path === "/smoke-test" ? 5 * 60 * 1000 : 35000'));
