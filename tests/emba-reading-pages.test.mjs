...
assert.equal(berkReading.editionBridge.items.length, 5, "Berk bridge should teach the five core Day 1 concepts");
assert.match(berkReading.editionBridge.title, /公司决定/);
