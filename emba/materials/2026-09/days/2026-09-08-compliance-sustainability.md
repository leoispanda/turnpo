...
3. **数据与问责**：把 IRO、value-chain boundary、metric、target、owner 和 assurance 连成可验证流程。
...
3. [ING (2018)｜Compliance case](../readings/summaries/ing-2018-compliance-case.md) — AML/KYC、monitoring 与治理失效。
