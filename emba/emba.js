...
const JULY_THINKING_FABLES = {
  T01: "井边的空桶\n\n阿拓每天在祠堂抄水渠图，家里的井却越来越浅。后来他提着空桶坐到井边，听见北坡挖断旧泉眼、村东水槽漏水、雨水被新墙挡住，便一条条去看。\n\n他没有画出新大图，只修漏槽、挪石头、改灌溉时间。井水不再下降。他懂得：学习的入口不是完美的图，而是一只每天都提不满的桶。",
  T02: "匠人的直尺\n\n鲁正的铜尺从不出错，徒弟们总等他给尺寸。阿言做了一张窄书桌，请鲁正坐下写信；他的手肘立刻撞到墙。阿言又问账房、学徒和腿脚不便的老先生。\n\n最后的桌子没有一条边符合鲁正最熟悉的比例，却让三个人都坐得舒服。鲁正收起铜尺，问：“你还看见了什么？”",
  T03: "红墨水的信\n\n校稿人宁川把主编的划线都当成对自己的指责。一次批注只有“开头太快”，他当场把纸折起来。傍晚，他看见小女孩读父亲的家书，母亲只是把前一句再念一遍。\n\n宁川回到桌前，写下：事实是什么？我听成了什么？还能怎么改？红墨水没有变温柔；他却不再把每一道批注都当成判决。",
  T04: "未完的陶罐\n\n陶工铺总由掌柜立刻替人重做裂罐，学徒便把坏罐藏起来。青禾却请掌柜先别修，说裂纹总从提耳下面开始；讲到第三次烧窑，她发现自己反复加厚提耳，只是在遮住第一次留下的手印。\n\n后来裂罐先放到长桌中央，主人先讲完它怎样裂、何时裂、自己猜为何裂。答案仍有人给，但总要晚一点到。",
  T05: "未点燃的火柴\n\n阿徊曾在港口告示墙写“也许可以把潮汐做成会动的地图”，雨一打湿就揭走了。浓雾让运药船错过港口时，他把想法画在木板上。\n\n渔夫画浅滩，孩子补上雾最重的时辰，守灯人写下旧灯照不到的水面。木板慢慢成了潮汐图：想法露出来，才有机会被现实试验。",
  T06: "背面的灰尘\n\n闻墨把书库按颜色、大小和借阅次数排好。一个孩子找候鸟的书，却从旧航海日志里找出观鸟图，图后还写着潮汐、风向和渔民口述。\n\n闻墨发现人们只按书脊找书。他让大家翻看背面、夹页和被忽略的目录。书库不再那么整齐，但人们开始带回从没问过的问题。",
  T07: "无声的旗杆\n\n船长赤衡挥旗决定船队航向，旗法越准，船员越少开口。一次穿越暗礁，老水手说潮线不对，年轻舵手说听见礁下撞击声。\n\n赤衡改挂白旗，叫船队先测水深。后来旗杆下多了一根短绳，任何船都能拉响它。愿意跟随，不是沉默，而是能一起看见危险、承担航向。",
  T08: "最小的齿轮\n\n钟塔修缮时，议会把最大的铜齿轮摆在大厅中央；上链、清灰和修小弹簧的人却在后门等候。开塔后钟锤没有落下，直到女孩拨正轴心里的小擒纵叉。\n\n她说，大轮蓄力，细叉放行，钟锤发声，清灰的人保证它们不卡住。价值不是谁最显眼，而是谁与谁不可替代地咬合。",
  T09: "旧航图的白边\n\n苏离相信祖父的海图不需要每天改动。第一年他照图绕开南岬，却在空海抛锚；第三年，北湾新长的沙洲截住两艘渔船。\n\n他在旧图旁铺开透明纸，每次出航画上风、潮和偏差。经验仍有价值，却不能替代今天的水位。",
  T10: "门槛上的椅子\n\n客栈挂着“人人欢迎”的木牌，外地客人却仍坐在门边。暴雨封路时，年轻车夫说桥有裂缝；掌柜先安慰，见他低头便把椅子搬到门槛上，请他画出位置。\n\n第二天，大家避开塌桥。掌柜撤下木牌，却保留椅子：谁带来坏消息或不合群的意见，都能先把话说完。",
  T11: "三层信鸽棚\n\n传令塔顶层带地图，中层带清单，底层带着沾泥纸条。新塔长把一切压成总表；三周后，北境车轮运到南境，南境的盐卡在断桥前。\n\n老鸽医摊开三张纸条：冬前补给、十车盐、桥板松动。各自都对，放在一起才说明问题。",
  T12: "没有门牌的房间\n\n老染师许岚一出城，学徒便把蓝布染成灰紫色。一个学徒发现，她每次做完都在墙角本子上写布料、天气、催单和例外。\n\n他们把墙角改成小房，门上不写“知识库”，只写“下一次”。每个染缸旁留短卡：谁做过、遇到什么、下次先看什么。",
  T13: "风筝与线轴\n\n阿临的风筝飞得很高，他便松开线轴。侧风把风筝卷向钟楼，他追着跑，不知道该收线还是放线。老人问：“你想让它去哪？”\n\n后来阿临仍让风筝飞高，但先选空地、看云层、留出余量并记录偏移。风筝给高度，线轴让他仍能决定方向。",
  T14: "会背答案的鹦鹉\n\n药铺鹦鹉能背整本草药目录。孩子拿来黄叶时，它立刻报药；老药师却问叶子长在阴处还是阳处、近来是否下霜，才发现只是自然落叶。\n\n老板从此让学徒面对陌生叶子，说明先看什么、排除什么、哪里仍不确定。掌握不只是复述答案。",
  T15: "回声纸\n\n书记员把村民意见写成漂亮公文，人们却说：“这不像我想说的。”制纸匠送来回声纸：先写原句，再用另一种墨水归纳，边缘才浮出淡淡回声。\n\n书记员先记录不同人的担忧，最后才排出选择。助手可以整理、照见和追问，不能替人发明一个看似完整的立场。",
  T16: "磨石上的刻痕\n\n客人只夸镰刀锋利，小徒弟禾舟却注意磨石上的刻痕。掌柜说客人不买磨石，便把它收进后屋；一个月后，新学徒总在同一位置磨出缺口。\n\n禾舟把磨石搬回门口，让每个人在旧铁片上试两下并写下改动。结果离开门店，学习让下一次不必从零开始。",
  T17: "一桶井水\n\n山村只有一口井。水变少后，菜农、旅店和老人互相责怪。一个挑水人画出饮用、牲口、灌溉三道线，又写下每天余水、取水量与例外。\n\n大家才发现争执不只为一桶水，而是没人知道水剩多少、谁有权先用。冲突常是稀缺、规则不清与信息不对称一起发出的声音。",
  T18: "两张戏票\n\n说书人棠月准备二十页新运河数字，台下的人却只算自己的货何时能到。她去问卖米的老周、赶考的姑娘和守渡口的孩子。\n\n第二天，她从一个七岁孩子等父亲回家的故事讲起。散场后，人们开始问堤防和船期。故事先决定谁需要理解什么，再让信息有地方停靠。",
  T19: "第二杯茶\n\n顾川在北城见人沉默，便认定冷淡；在南市听人抢着说，便认定浮躁。山城主人不断添茶却少说话，他以为对方没兴趣。\n\n客栈老板说，添第二杯茶是在等客人说出真正条件。顾川回去先问风险，最终改用更稳妥的交货安排。第一感觉有时提醒危险；但别把自己的习惯当成别人的定义。"
};
