...
flowchart TB
    Q["总问题：组织如何创造并保护长期价值？"]
    D1["Day 1｜创造价值<br/>投资、融资、市场定价、风险管理"]
    D2["Day 2｜保护信任与经营资格<br/>Compliance、culture、double materiality、assurance"]
    D3["Day 3｜建立证据与责任闭环<br/>Financial Accounting、ERM、governance、public value"]
    D4["Day 4｜把战略变成行为<br/>Cost、KPI、ranking、innovation control、purpose"]
    D5["Day 5｜公平比较并形成建议<br/>Industry structure、benchmark、risk-adjusted return、suitability"]
    O["Integrated managerial recommendation<br/>Decision + evidence + trade-off + action + limitation + reflection"]

    Q --> D1
    Q --> D2
    D1 -->|"投资与融资结果进入报表"| D3
    D2 -->|"合规与 ESG 信息进入风险和治理"| D3
    D3 -->|"证据、目标与风险进入控制设计"| D4
    D4 -->|"指标与激励改变行为和数据质量"| D2
    D1 -->|"risk-return 与市场逻辑"| D5
    D2 -->|"披露可信度与 conduct boundary"| D5
    D3 -->|"证据质量与责任"| D5
    D4 -->|"比较指标会塑造行为"| D5
    D5 --> O
```
